...
public class TestUpdateMovie {
	...
	// explicit wait
//  WebDriverWait wait = new WebDriverWait(driver, 10); WebElement messageElement = 
//  		wait.until( ExpectedConditions.presenceOfElementLocated(By.id("loginResponse")) );
	...
	@Test
	public void AdvancedSearchForm () {
		driver = new ChromeDriver();
        driver.get("http://localhost:8080/movie3/MovieListControllerServlet?command=ADMIN_LIST");
